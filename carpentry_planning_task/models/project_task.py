...
class Task(models.Model):
    ...
    def _compute_is_late(self):
        for task in self:
            ...
            date_end_or_today = task.date_end.date() if task.date_end else fields.Date.today()
            task.is_late = date_end_or_today > task.date_deadline if task.date_deadline else False
